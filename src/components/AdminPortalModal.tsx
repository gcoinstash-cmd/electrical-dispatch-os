        ...
        <div className="flex items-center justify-between pb-5 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 font-mono mt-0.5">Medium-Voltage Switchgear & EV Fast Charging</p>
            </div>
          </div>
          <button
            onClick={onClose}
            ...
            <div className="bg-purple-950/30 border border-purple-500/20 rounded-xl p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <button
                  ...
                  className="mt-3 inline-flex items-center gap-2 px-3.5 py-1.5 rounded-lg bg-purple-500 text-white text-xs font-mono font-bold tracking-wider hover:bg-purple-400 transition-all shadow-lg shadow-purple-500/20"
                >
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    type="submit"
                    className="absolute right-2 top-2 bottom-2 px-4 bg-purple-500/20 hover:bg-purple-500/30 text-purple-300 rounded-lg text-xs font-mono transition-colors flex items-center gap-1.5"
                  >
          ...
          <div className="py-6 space-y-6">
            <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 font-mono mt-0.5">Session: VOLT-480V-TX-2026</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="p-3 bg-[#0b0811] rounded-xl border border-white/5 text-center">
                ...
                <div className="text-[10px] text-slate-400 uppercase font-mono">Grid Bus Feed</div>
              </div>
              <div className="p-3 bg-[#0b0811] rounded-xl border border-white/5 text-center">
